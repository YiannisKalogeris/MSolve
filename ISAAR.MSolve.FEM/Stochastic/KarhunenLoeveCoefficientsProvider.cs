...
namespace ISAAR.MSolve.PreProcessor.Stochastic
{
    public static class KarhunenLoeveCoefficientsProvider
    {
        ...
        public static Tuple<double[], double[], double[,]> KarhunenLoeveFredholmWithFEM(int KarLoeveTerms, double[] domainBounds, double sigmaSquare, int partition, double correlationLength)
        {
            //FEM parameters 
