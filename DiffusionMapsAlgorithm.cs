...
{
    /// <summary>
    ///     Class implementing the Diffusion Maps algorithm
    ///     J. Harlim . "Data-Driven Computational Methods", Cambridge University Press, 2018.
    /// </summary>
    public class DiffusionMapsAlgorithm
    {
        ...
        private double[,] ImportData()
        {
            ...
            double[,] dataSet = File.ReadLines(filePath).Select(x => x.Split(',')).ToArray();
